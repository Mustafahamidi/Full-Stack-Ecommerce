    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      <div>
        ...
        <div className='w-full'>
          ...
          <input onChange={(e) => setName(e.target.value)} value={name} type="text" className='w-full max-w-[500px] px-3 py-2 ' required placeholder='Type here' />
        </div>
        

        <div className='w-full'>
          <p className='mb-2'>Product description</p>
          <textarea onChange={(e) => setDescription(e.target.value)} value={description} type="text" className='w-full max-w-[500px] px-3 py-2 ' required placeholder='Write content here' />
        </div>
      </div>
      ...
      <button type='submit' className='w-28 py-3 mt-4 bg-black text-white hover:opacity-80'>Add</button>
    </form>
  )
}

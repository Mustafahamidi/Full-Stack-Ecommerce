...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            <Link to="/">
                <img src={assets.logo_hs} className='w-20' alt='' />
            </Link>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                ...
                {/* ✅ Admin External Link */}
                <a 
                    href="https://hamid-admin.vercel.app/" 
                    target="_blank" 
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to="/cart" className='relative'>
                    ...
                    <p className='absolute top-[10px] right-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>
                        {getCartCount()}
                    </p>
                </Link>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full': 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    {/* ✅ Admin External Link in Mobile Menu */}
                    <a 
